...
function buildLabelOverlay(id) {
  ...
  const storePhone   = s.whatsapp      ? String(s.whatsapp).replace(/^55/,'').replace(/(\d{2})(\d{5})(\d{4})/,'($1) $2-$3') : '(11) 97833-2442';
...
async function renderPortal() {
  ...
  try {
    ...
    root.innerHTML = '<div class="card" style="padding:24px;color:var(--red)">Não foi possível carregar seus dados. Fale com a TopFood: (11) 97833-2442.</div>';
    return;
  }
  ...
  root.innerHTML = `
    <div style="display:grid;gap:16px;max-width:760px;padding-bottom:86px">
      ...
      <div class="card" style="padding:18px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px">
        ...
        <a class="btn btn-wa" href="https://wa.me/5511978332442?text=${encodeURIComponent('Olá! Sou da ' + e.nome + ' e preciso de ajuda no portal.')}" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> Falar com a TopFood</a>
      </div>
