...
const WHATS = 'https://wa.me/5511978332442';
...
const GUIAS = {
  ...
  'embalagem-personalizada-vale-a-pena': {
    ...
    faq: [
      ...
      { q: 'Como faço para personalizar com a minha marca?', a: 'Chama no WhatsApp (11) 97833-2442 com o seu volume mensal que a gente orienta o melhor caminho — do adesivo à impressão exclusiva.' },
...
<body>
<div class="topbar"><span>🚚 Frete para todo Brasil &nbsp;|&nbsp; 📦 Pacotes a partir de 50 un</span><a href="${WHATS}">📱 (11) 97833-2442</a></div>
<header class="header">
...
<div class="container">
  ...
  <p style="margin-top:28px">Ficou com dúvida? Fale com a gente no <a href="${WHATS}">WhatsApp (11) 97833-2442</a> e peça seu orçamento.</p>
